//Esta es una nueva propuesta para el manejo de las fechas :)
import java.time.LocalDate;
import java.util.Scanner;

public class CalendarioCarreras2 {
    //Atributos
    String carrera;
    ...
    //Constructor
    public CalendarioCarreras2(String carrera, String fechainicio, String fechafinal){
    ...
    //Metodos adicionales
    public static CalendarioCarreras2 crearCalendarioCarrera(){
        ...
        CalendarioCarreras2 carrera_calendario = new CalendarioCarreras2(carrera, inicio, fin);
